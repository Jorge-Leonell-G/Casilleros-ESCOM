<%-- 
    Document   : formBan
    Created on : 18 jun 2023, 11:23:45
    Author     : leone
--%>
...
--%>
<%
  if(session.getAttribute("baneado") != null){  
%>
<html>
    <head>
        <meta charset="utf-8">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">${baneado.nombreUsuario}</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>                    
                                            Bienvenido - ${baneado.nombreUsuario}
                                            <small>Usted es, ${baneado.rol.nombreRol}</small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>Bienvenido, ${baneado.nombreUsuario}</p>
                            <!-- Status -->
